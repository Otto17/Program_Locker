...
После установки пароля ввести его ещё раз и нажать кнопку "**Добавить файлы…**", выбрать EXE файл(ы) и добавить их, файлы сразу защитятся, там же можно сразу запустить программу(мы), снять защиту, либо удалить программу(мы) из списка записей.
...
P.S. При добавлении Google Chrome, в случаи его обновления, защита снимается автоматически и больше не устанавливается, установить её нужно повторно вручную, из "_Locker Launcher_", это связано с механизмом защиты Google Chrome при его обновлении.
